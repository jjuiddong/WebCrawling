...
bool cCapture::Capture(int x, int y, int w, int h, const char *fileName)
{
	...
	HPALETTE hpal = NULL;
	if (SaveBitmap(fileName, hBitmap, hpal))
		return true;
...
bool cCapture::SaveBitmap(LPCSTR filename, HBITMAP bmp, HPALETTE pal)
{
	bool result = false;
	PICTDESC pd;
